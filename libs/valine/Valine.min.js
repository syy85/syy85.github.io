...
if (t.get("mail").indexOf("@qq.com") >= 0) {
	var prefix = t.get("mail").replace(/@.*/, "");//鍓嶇紑
	var pattern = /^\d+$/g;  //姝ｅ垯琛ㄨ揪寮�
	var result = prefix.match(pattern);//match 鏄尮閰嶇殑鎰忔€�
	if (result !== null) {
...
{"use strict";t.__esModule=!0;
  ...
  var r=n(5),o={data:n(55),parse:function(e){
    return String(e).replace(/:(.+?):/g,
      function(e,t){//e:鍥剧墖鍦板潃, t:鏍囩鍚�
        //if (o.data[t] == e){ //闃叉閿欒瑙﹀彂:xxx: 涓嶆槸琛ㄦ儏鍖呮爣绛�
...
function aru(str){
        ...
        }},function(e,t,n){var r=n(57);"string"==typeof r&&(r=[[e.i,r,""]]);var o={};o.transform=void 0;n(59)
